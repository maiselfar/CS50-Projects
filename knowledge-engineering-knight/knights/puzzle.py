...
basic_knowledge = And (  
    ...
    Not(And(AKnight, AKnave)),  #A cant be both a knight ot a knave
    Or(BKnight, BKnave),        #B must be either a knight or a knave
    Not(And(BKnave,BKnight)),   #B cant be both a knight ot a knave
    Or(CKnight, CKnave),        #C must be either a knight or a knave
    Not(And(CKnave, CKnight)),  #C cant be both a knight ot a knave)
)
